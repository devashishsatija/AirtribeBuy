...
const Home = (product) => {
    ...
    if (isNaN(value) || value <= 0) {
      return; // Ignore invalid or zero/negative values
    }

    
    debouncedUpdateQuantity(Productid, value);
    addToCart((prevCart) => {
        const updatedProduct = { ...prevCart[Productid], quantity: value };
        const modifiedCart = { ...prevCart, [Productid]: updatedProduct };
        updateCartInLocalStorage(modifiedCart); // Save to localStorage
        return modifiedCart;
    });
    }
                    ...
                    <Grid.Col mah={800} key={product.id} span={{ base: 12, md: 6, lg: 3 }}>
                        <Card onClick={() => {
                            ...
                            <Group justify="stretch" align="center" gap={5}>
                                ...
                                <NumberInput  value={cartItem.quantity}
